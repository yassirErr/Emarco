...
namespace Emarco.Areas.Customer.Controllers
{
	...
	public class CartController : Controller
	{
		...
		public IActionResult OrderConfirmation(int id)
		{
			...
			_emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - Emarco ","<p>New Order Created</p>");
		...
		public IActionResult Remove(int cartId)
		{
			...
			//sHttpContext.Session.SetInt32(StaticDetails.SessionCart, count);
			return RedirectToAction(nameof(Index));
		}
